...
function callEvents(year) {
  var pH1 =
    ...
    year +
    "/keys?X-TBA-Auth-Key=lrqZK0XAvSpeHXuWi9vhbmnAbF4ueBRQB3OevJC1pOWIWQdwX1WKRJ4oQceP0ox5";
  let pH2 = new URL(pH1);
...
function callTeams(eKey, year, u) {
  ...
  var pH4 =
    ...
    eKey +
    "/teams/keys?X-TBA-Auth-Key=lrqZK0XAvSpeHXuWi9vhbmnAbF4ueBRQB3OevJC1pOWIWQdwX1WKRJ4oQceP0ox5";
  let pH5 = new URL(pH4);
        ...
        for (pH6 = 0; pH6 < myJson.length; pH6++) {
          if (x == 1) {
            process(
              ...
              eKey,
              year,
              "lrqZK0XAvSpeHXuWi9vhbmnAbF4ueBRQB3OevJC1pOWIWQdwX1WKRJ4oQceP0ox5",
              pH6 + u
            );
            var ref = db.ref("/" + year);
            x = 0;
            ...
            process(
              ...
              eKey,
              year,
              "eGAeqTgTHJcHhMWBaTToL9qihuJLsHobLS64C5HsfZBB2t3csdxzngRuOMjLrWLf",
              pH6 + u
            );
            x = 1;
          }
...
function process(tKey, eKey, year, apiKey, u) {
  ...
  fetch(ok2)
    ...
    .then((myJson) => {
      ...
      if (this["wltRec" + u] != null) {
        if (
          this["wltRec" + u].qual == null &&
          this["wltRec" + u].playoff == null
        ) {
          // console.log(myJson);
        } else {
          if (
            ...
            this["wltratio" + u] = (
              this["wins" + u] /
              (this["wins" + u] + this["losses" + u] + this["ties" + u])
            ).toFixed(2);
            ...
            inPlayoffs = true;
            this["wins" + u] =
              this["wltRec" + u].playoff.record.wins +
              this["wltRec" + u].qual.ranking.record.wins;
            this["losses" + u] =
              this["wltRec" + u].playoff.record.losses +
              this["wltRec" + u].qual.ranking.record.losses;
            this["ties" + u] =
              this["wltRec" + u].playoff.record.ties +
              this["wltRec" + u].qual.ranking.record.ties;
  ...
  fetch(ok)
    ...
    .then((myJson) => {
      ...
      for (
        this["matchNum" + u] = 0;
        this["matchNum" + u] < this["teamScoreRequestObj" + u].length;
        this["matchNum" + u]++
      ) {
        this["blueKeyArray" + u] =
          this["teamScoreRequestObj" + u][
            this["matchNum" + u]
          ].alliances.blue.team_keys;

        if (
          this["teamScoreRequestObj" + u][this["matchNum" + u]].alliances.blue
            .score >= 0
        ) {
          gamesPlayed++;
          if (this["blueKeyArray" + u].includes(tKey)) {
            if (
              this["teamScoreRequestObj" + u][this["matchNum" + u]].alliances ==
                undefined ||
              this["teamScoreRequestObj" + u][this["matchNum" + u]].alliances ==
                null ||
              this["teamScoreRequestObj" + u][this["matchNum" + u]]
              ...
              this["bottomVar" + u] +=
                this["teamScoreRequestObj" + u][this["matchNum" + u]]
                  .score_breakdown.blue.autoCellsBottom +
                this["teamScoreRequestObj" + u][this["matchNum" + u]]
                  .score_breakdown.red.teleopCellsBottom;
              this["autoTotal" + u] +=
                this["teamScoreRequestObj" + u][
                  this["matchNum" + u]
            ...
            if (
              ...
              this["bottomVar" + u] +=
                this["teamScoreRequestObj" + u][this["matchNum" + u]]
                  .score_breakdown.red.autoCellsBottom +
                this["teamScoreRequestObj" + u][this["matchNum" + u]]
                  .score_breakdown.red.teleopCellsBottom;
              this["autoTotal" + u] +=
                this["teamScoreRequestObj" + u][
      ...
      this["teamAvg" + u] = (
        this["teamTotal" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["autoAvg" + u] = (
        this["autoTotal" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["tOPAvg" + u] = (
        this["tOPTotal" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["outerAvg" + u] = (
        this["outerVar" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["innerAvg" + u] = (
        this["innerVar" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["bottomAvg" + u] = (
        this["bottomVar" + u] / this["teamScoreRequestObj" + u].length
      ).toFixed(2);
      this["teamTotal" + u];
      wins;
      losses;
